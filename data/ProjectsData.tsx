...
export const projectsData: Record<string, Project> = {
  "Mobile M": {
    ...
    videos: [
      { id: 5, url: "Videos/Mobile m/million_.mp4", poster: "Videos/Mobile m/poster/million_.jpg" },
      { id: 6, url: "Videos/Mobile m/redmi bon .mp4", poster: "Videos/Mobile m/poster/redmi bon .jpg" },
      { id: 7, url: "Videos/Mobile m/REMIS A NEUF .mp4", poster: "Videos/Mobile m/poster/REMIS A NEUF .jpg" },
      { id: 8, url: "Videos/Mobile m/trend .mp4", poster: "Videos/Mobile m/poster/trend .jpg" },
    ],
    stats: {
  ...
  "Easy démarches": {
    ...
    videos: [
      { id: 1, url: "Videos/Easy démarches/Vidéo 1.mp4", poster: "Videos/Easy démarches/poster/Vidéo 1.jpg" },
      { id: 2, url: "Videos/Easy démarches/Vidéo 2.mp4", poster: "Videos/Easy démarches/poster/Vidéo 2.jpg" },
      { id: 3, url: "Videos/Easy démarches/Vidéo 3.mp4", poster: "Videos/Easy démarches/poster/Vidéo 3.jpg" },
      { id: 4, url: "Videos/Easy démarches/Vidéo 4.mp4", poster: "Videos/Easy démarches/poster/Vidéo 4.jpg" },
    ],
    stats: {
      views: "+100 000 vues générées",
